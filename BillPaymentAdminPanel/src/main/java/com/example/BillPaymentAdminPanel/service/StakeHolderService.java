...
public class StakeHolderService {
    ...
    public List<StakeHolder> activeStakeHolder(int id){
        return stakeHolderRepository.findByStatus(id);
    }

    public StakeHolder get(int id, String address){
        return stakeHolderRepository.findByIdAndAddress(id, address);
    }
}
